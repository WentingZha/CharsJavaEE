...
public class NewsServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        PageInfo<List<News>> page = service.pagingQuery(Integer.parseInt(start), Integer.parseInt(pageSize));

//        Page<News> currentPage = PageHelper.startPage(Integer.parseInt(start),Integer.parseInt(pageSize));
